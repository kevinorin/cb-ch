...
textileSettings = {
	...
	markupSet: [
		...
		{separator:'---------------' },
		//{name:'Picture', replaceWith:'![![Source:!:https://]!]([![Alternative text]!])!'}, 
		...
		{name:'Link', openWith:'"', closeWith:'":[![Link:!:https://]!]', placeHolder:'Your text to link here...' },
		{separator:'---------------' },
...
markdownSettings = {
	...
	markupSet: [
		...
		{separator:'---------------' },
		//{name:'Picture', key:'P', replaceWith:'![[![Alternative text]!]]([![Url:!:https://]!] "[![Title]!]")'},
		...
		{name:'Link', key:'L', openWith:'[', closeWith:']([![Url:!:https://]!] "[![Title]!]")', placeHolder:'Your text to link here...' },
		{separator:'---------------'},	
