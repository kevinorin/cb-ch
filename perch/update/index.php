            ...
            <div class="cont">
                ...
                <?php
                    ...
                    if (!$errors) {
                        ...
                        echo '<p>' . sprintf(PerchLang::get('The errors could be due to running update more than once. Otherwise, %scontact support%s and let us know what went wrong.'),'<a href="https://support.grabaperch.com">','</a>');
                    }
                ?>
