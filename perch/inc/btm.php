...
?>
    <div id="footer">
		...
		<div class="credit">
            ...
            ?>
			<p><a href="https://grabaperch.com"><img src="<?php echo PERCH_LOGINPATH; ?>/assets/img/perch.gif" width="35" height="12" alt="Perch" /></a>
			<?php echo PerchUtil::html(PerchLang::get('by')); ?> <a href="https://edgeofmyseat.com">edgeofmyseat.com</a></p>
            <?php
                }else{
                    echo '&nbsp;';
                }
